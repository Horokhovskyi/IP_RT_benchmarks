...
# Achrom
pred_achrom <- list.files("results_MeV/predict/achrom/", pattern = ".csv", full.names = T) %>%
  lapply(vroom, show_col_types = FALSE)
names(pred_achrom) <- list.files("results_MeV/predict/achrom//", pattern = ".csv", full.names = F, recursive = T) %>%
...
# Deep LC
pred_DeepLC <- list.files("results_MeV/predict/DeepLC/", pattern = ".csv", full.names = T) %>%
  lapply(vroom, show_col_types = FALSE)
names(pred_DeepLC) <- list.files("results_MeV/predict/DeepLC/", pattern = ".csv", full.names = F, recursive = T) %>%
  str_remove_all(pattern = ".csv")
...
# Prosit
pred_Prosit <- list.files("results_MeV/predict/Prosit/", pattern = "prositPred", full.names = T, recursive = T) %>%
  lapply(vroom, show_col_types = FALSE)
names(pred_Prosit) <- list.files("results_MeV/predict/Prosit/", pattern = "prositPred", full.names = F, recursive = T) %>%
